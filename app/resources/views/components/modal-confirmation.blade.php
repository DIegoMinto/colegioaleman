<!-- Componente Modal Reutilizable de Confirmación -->
<div x-data="{ 
        open: false, 
        title: '', 
        message: '', 
        ...
        abrirModal(title, message, url) {
            this.title = title;
            this.message = message;
            this.actionUrl = url;
            this.open = true;
        }
    }" @abrir-modal.window="abrirModal($event.detail.title, $event.detail.message, $event.detail.url)" x-show="open"
    x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
